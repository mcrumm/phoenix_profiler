defmodule FriendsOfPhoenix.Debug.View do
  ...
  def render("toolbar.html", assigns) do
    ...
    .phxweb-toolbar-view {
      ...
      font: var(--size-font) var(--font-sans);
      left: 0;
      margin: 0;
      padding: 0 var(--size-9) 0 0;
      position: fixed;
      right: 0;
      text-align: left;
      text-transform: none;
    ...
    .phxweb-toolbar-view svg,
    .phxweb-toolbar-view img {
      /* height: 20px; */
      /* width: 20px; */
    ...
    .phxweb-toolbar-panel:hover {
      background-color: var(--oc-gray-8);
    }

    .phxweb-toolbar-panel:active {
      background-color: var(--oc-gray-8);
    }

    .phxweb-toolbar-panel .phxweb-toolbar-value {
      color: var(--color-fg-default);
    ...
    .phxweb-toolbar-panel .phxweb-toolbar-icon {
      display: block;
      height: var(--size-bar-height);
    ...
    .phxweb-toolbar .phxweb-toolbar-icon > svg {
      width: var(--size-icon);
    ...
    .phxweb-toolbar-panel .phxweb-toolbar-icon img + span,
    .phxweb-toolbar-panel .phxweb-toolbar-icon svg + span {
      margin-left: var(--size-1);
    }

    .phxweb-toolbar-icon .phxweb-toolbar-value {
      margin-left: var(--size-1);
      color: var(--oc-gray-1);
    }

    .phxweb-toolbar-icon .phxweb-toolbar-label {
      color: var(--oc-gray-6);
    }

    /**** Panel: Info ****/

    .phxweb-toolbar-panel .phxweb-toolbar-info {
      background-color: var(--oc-gray-8);
      bottom: var(--size-bar-height);
      color: var(--oc-gray-2);
      display: none;
    ...
    .phxweb-toolbar-panel:hover .phxweb-toolbar-info,
    .phxweb-toolbar-panel.hover .phxweb-toolbar-info {
      display: block;
      padding: var(--size-3);
    ...
    .phxweb-toolbar-panel-request .phxweb-toolbar-icon {
      padding-left: var(--size-0);
      padding-right: var(--size-0);
    }

    .phxweb-toolbar-panel-request .phxweb-toolbar-status {
      background-color: var(--color-canvas-default);
      color: var(--color-fg-default);
      display: inline-block;
      font-size: var(--size-font);
    ...
    .phxweb-toolbar-panel-request .phxweb-toolbar-status.green{
      background-color: var(--color-success);
    }

    .phxweb-toolbar-panel-request .phxweb-toolbar-status.yellow{
      background-color: var(--color-warn);
    }

    .phxweb-toolbar-panel-request .phxweb-toolbar-status.red{
    ...
    .phxweb-toolbar-panel-config .phxweb-toolbar-label {
      float: left;
      display: inline-block;
    ...
    .phxweb-toolbar .phxweb-toolbar-view .hide-button {
      background-color: var(--oc-gray-8);
      display: block;
      position: absolute;
      top: 0;
      right: 0;
      width: var(--size-bar-height);
      height: var(--size-bar-height);
      cursor: pointer;
      text-align: center;
      border: none;
    ...
    .phxweb-toolbar .phxweb-toolbar-view .hide-button svg {
      color: var(--color-fg-default);
      margin-top: var(--size-2);
    ...
    @media (min-width: 768px) {
      .phxweb-toolbar-icon .phxweb-toolbar-label, .phxweb-toolbar-icon .phxweb-toolbar-value {
          display: inline;
      }
      ...
      .phxweb-toolbar-panel-duration .phxweb-toolbar-icon svg + span, .phxweb-toolbar-panel-memory .phxweb-toolbar-icon svg + span {
          margin-left: 0;
      }
      ...
      .phxweb-toolbar-panel-duration .phxweb-toolbar-icon {
          padding-right: var(--size-1);
      }

      .phxweb-toolbar-panel-memory .phxweb-toolbar-icon {
      ...
      .phxweb-toolbar-panel-request .phxweb-toolbar-label {
          margin-left: var(--size-1);
      }

      .phxweb-toolbar-panel-request .phxweb-toolbar-status + svg {
          margin-left: var(--size-1);
      }

      .phxweb-toolbar-panel-request .phxweb-toolbar-icon svg + .phxweb-toolbar-label {
          margin-left: 0;
      }

      .phxweb-toolbar-panel-request .phxweb-toolbar-label + .phxweb-toolbar-value {
          margin-right: var(--size-2);
      }

      .phxweb-toolbar-panel-request:hover .phxweb-toolbar-info {
          max-width: none;
      }
      ...
      .phxweb-toolbar-panel .phxweb-toolbar-info-item span {
          font-size: 13px;
      }

      .phxweb-toolbar-panel-right {
          float: right;
          margin-left: 0;
          margin-right: 0;
      }
