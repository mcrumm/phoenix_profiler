defmodule FriendsOfPhoenix.Debug.View do
  ...
  def render("root.html", assigns) do
    ...
    <style>
      ...
      button.dbg-btn:hover {
        background-color: var(--color-button-hover);
      }

      button.dbg-btn:active {
        background-color: var(--color-button-active);
      }

      button.dbg-btn[disabled] {
      ...
      /* Pseudo-button + unit */
      .dbg-btn.measurement > span.value {
        color: var(--color-button-measurement-value);
      }

      .dbg-btn.measurement > span.unit {
        color: var(--color-button-measurement-unit);
      }

      /* Button: Status Code */
      button.dbg-btn.status{
      ...
      /* Button: Logo */
      .dbg-ctrl-group > .dbg-btn.logo {
        padding: 8px 5px;
        width: var(--size-logo-width);
        height: var(--size-logo-height);
      }

      .dbg-ctrl-group > .dbg-btn.logo:before {
          content: '';
          display: block;
          height: var(--size-logo-height);
          width: var(--size-logo-width);
      ...
      /* Button: Version */
      .dbg-ctrl-group > .dbg-btn.vsn {
        flex: 1;
      }

    </style>
    </head>
    <body id="fophx-dbg-wrapper" data-token={@fophx_debug}>
      <%= @inner_content %>
    </body>
    </html>
    """
